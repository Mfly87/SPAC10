...
class FakerName(AbsFaker):
    ...
    def create_male_name(self) -> list[SQLDataName]:
        _name_first = self.generate_name_first_male()
        _name_last = self.generate_name_last()
        return self._create_name(_name_first, _name_last)

    def create_female_name(self) -> list[SQLDataName]:
        _name_first = self.generate_name_first_female()
        _name_last = self.generate_name_last()
        return self._create_name(_name_first, _name_last)
